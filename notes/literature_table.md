...
|---:|---|---|---|---|---|---|---|---|---|
| 1 | *Interpretability in the Wild: a Circuit for IOI in GPT-2 Small* | Devre keşfi | GPT-2 Small | Attention / MLP bileşenleri | Devre analizi | Bileşen düzeyi müdahaleler | Devre düzeyinde mekanizma yeniden kurma | Week 1 E07/E15–E19 aday devre, ablasyon ve kontrol mantığı | Büyük dil modeli bağlamı; MNIST MLP'den farklı |
| 2 | *Towards Automated Circuit Discovery for Mechanistic Interpretability* | Devre keşfinin otomasyonu | Sinir ağı / Transformer bağlamı | Model bileşenleri | Otomatik devre araması | Bileşen müdahalesi | Aday devre keşfi metodolojisi | Week 1 E07/E15–E19; Week 2 E06 devre tekrarı | Otomatik keşif kapsamı bu çalışmada sınırlı |
| 3 | *Locating and Editing Factual Associations in GPT* | İçsel olgusal temsiller | GPT | MLP / iç temsiller | Yerelleştirme ve düzenleme | Aktivasyon/temsil düzenleme | İç temsil üzerinde kontrollü müdahale | Week 1 E05/E09–E12 aktivasyon müdahalesi ve yamalama | Dil modeli özelinde |
| 4 | *Toy Models of Superposition* | Özellikler ve süperpozisyon | Oyuncak sinir ağları | Dağıtık özellikler | Temsil analizi | Kontrollü özellik manipülasyonu | Özelliklerin tek nöron yerine dağıtık olabileceğini gösteren temel çerçeve | Week 1 E10/E18; dağıtık grup etkisi ve aşamalı ablasyon | Oyuncak model sonuçlarının doğrudan MNIST'e genellenmesi sınırlı |
...
| 11 | *Formal Mechanistic Interpretability: Automated Circuit Discovery with Provable Guarantees* | Formal devre doğrulaması | Sinir ağları / vision modelleri | Devre altgrafları | Otomatik devre keşfi + neural verification | Robust patching / minimality / domain guarantees | Devre keşfine formel doğrulama ve robustness garantileri ekleme | Week 2 E06–E10 kontrol/doğrulama mantığı için ileri yöntem referansı | 2026 çalışması; bu araştırmada formel doğrulama uygulanmamıştır |
...
| Aktivasyon Müdahalesi | **Week 1 E05, E08** | N47/N54/N17 ölçekleme ve çıktı olasılığı değişimi |
| Korelasyon ve Nedensellik | **Week 1 E06** | N17/N47 korelasyonu `0.4485` genel, `0.7846` Sınıf 0; müdahale ile ayrım |
| Aktivasyon Yamalama | **Week 1 E09, E12** | Tekli/grup yamalama ve logit düzeyi etkiler |
| Dağıtık Temsil | **Week 1 E10, E18** | Top-1/3/5 yamalama ve aşamalı ablasyon |
| Devre Keşfi | **Week 1 E07, E15–E19; Week 2 E06** | Aday devre, birlikte ablasyon, tekli çıkarma, random controls ve multi-seed tekrar |
| Mekanistik Doğrulama | **Week 1 E16/E19; Week 2 E06/E09** | Sınıf bazlı kontroller, random controls, tekrar ve istatistiksel kontrol |
