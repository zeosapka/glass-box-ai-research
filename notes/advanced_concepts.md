...
Bu dosya, ödevde istenen ileri kavramları tanım + bu araştırmadaki işlevleri ile kaydeder. Uygulanmayan yöntemler uygulanmış deney gibi sunulmaz.
...
| Katkı Yamalama (Attribution Patching) | İç bileşenlerin katkısını tahmin ederek adayları önceliklendirme | Büyük mekanizma aramasında aday sıralaması sağlar | Kavramsal; ayrı yöntem olarak uygulanmadı |
| Nedensel İzleme (Causal Tracing) | Çıktı etkisinin iç yol boyunca izlenmesi | Aday devrenin hangi yol üzerinden etki ettiğini araştırır | Kavramsal; doğrudan uygulanmadı |
...
Bu üç yöntem bu araştırmada doğrudan çalıştırılmamış; literatür ve gelecek metodoloji bağlamında tutulmuştur.
